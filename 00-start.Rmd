...
- [Tietotyypit: matriisi, taulukko, lista ja data frame](#data_types)
  * [matriisi (matrix)](#matriisi)
  * [taulukko (array)](#taulukko)
  * [lista (list)](#lista)
  * [data frame](#data-frame)
- [Datan sisään lukeminen](#reading_data)
...
<img src="files/00-start/software_center.jpg" alt="" width="300"/>

RStudio:n voi asentaa Software Centeristä, ja RStudion pitäisi sen jälkeen olla käytettävissä.

<img src="files/00-start/RStudio_sc.jpg" alt="" width="300"/>
...
<img src="files/00-start/RStudio_tutorial_edited.jpg" alt="" width="600"/>
...
<img src="files/00-start/package_install.jpg" alt="" width="700"/>
 ...
 <img src="files/00-start/install_rkurssi.jpg" alt="" width="300"/>
