...
remotes::install_github("santikka/R-course/Rcourse")
```
...
Mikäli käytät nimen `vast` sijasta jotain muuta nimeä, niin sinun on käytettävä samaa nimä myös vastaa-funktion argumenttina!
