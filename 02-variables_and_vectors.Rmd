...
Edellisessä esimerkissä **sijoitetaan (assign)** eli tallennetaan muuttujaan x arvo 3 ja muuttujaan y arvo 4. Sen jälkeen muuttujien x ja y summa sijoitetaan muuttujaan z, jonka jälkeen tulostetaan muuttujan z arvo.
 `<-` on R:n **sijoitusoperaattori** (myös yhtä kuin-merkki `=` toimii melkein aina, mutta `<-` merkin käyttöä suositellaan vahvasti).
...
<!-- Santtu: Olen edellisessä eri mieltä siitä, koodia kirjoitetaan ihmisille. Kuten aikaisemmin todettiin, koodin tarkoitus on saada  tietokone toteuttamaan jokin tehtävä, kaikki muu on toissijaista. -->
<!-- Hyvä nyrkkisääntö on muistaa, että koodia kirjoitetaan ihmisille, ei koneelle.-->
