...
<!-- En puhuisi viikoista, aiheuttaa vain hämmennystä -->
Tässä kappaleessa tutustutaan kuvaajien piirtämiseen. <!-- Moodlessa on aiheesta myös suomenkielinen opetusvideo, mutta tässä ovat silti lyhyet kirjalliset ohjeet suomeksi. -->
...
```
<!-- Santtu: Viikon tehtävä? Eikö materiaalin tulisi olla kurssin iteraatiosta riippumaton -->
