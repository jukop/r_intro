...
<!-- Santtu: ihan vain huomiona, onko ohjelmointikieltä jossa a < x < b toimisi suoraan? Itse en ainakaan tiedä yhtäkään, ehkä Haskell mutta en muista.-->
...
Tällä hetkellä funktiomme toimii vain naispotilaille, sillä miehillä hemoglobiiniarvojen alaraja on 134. Lisätään siis funktioomme argumentti `sex`  sukupuolta varten ja muokataan funktion toimintaa niin, että se osaa ottaa huomioon sukupuolen. Nyt if-rakenteen ehdosta tulee jo hieman monimutkaisempi:
...
<!-- Santtu: Mielestäni näiden tarkastusten tulisi kutsua stop, eikä palauttaa tekstiä, kyseessä on kuitenkin virhetilanne -->
...
<!--Tätä aihetta käsitellään enemmän ensi viikolla, mutta tässä lyhyt vinkki tällaisten tehtävien ratkaisuun:-->
...
<!--Kun vektoroidulle funktiolle annetaan vektori, jossa on monta alkiota, funktio ajetaan automaattisesti alkio kerrallaan, kuten monet R:n omat funktiot. -->
